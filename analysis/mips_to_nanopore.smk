...
rule all:
	input:
		sorted_bams=expand(config['output_dir'] +'/mapping/bam_files/{sample}.sorted.bam.bai', sample=get_samples()),
...
Section 1) prep samples - DONE IN OTHER SMK FILE NOW
_______________________________________________________________________________________________________________________________________
...
# Section 3) variant_calling_section
_______________________________________________________________________________________________________________________________________
...
# Section 4) vcf_to_tables_section
_______________________________________________________________________________________________________________________________________
"""
...
# Section 5) miplithon_and_mamplicoRn_section
_______________________________________________________________________________________________________________________________________
"""
...
# Section 6) generate_count_summaries_section
_______________________________________________________________________________________________________________________________________
"""
